...
async def _ideate(state: dict, manager) -> dict:
    ...
    prompt_parts.extend([
        ...
        '- "project": "spectre", "conduit", or "new" (for an entirely new project/tool)',
        '- "effort": "small" (1-2 files), "medium" (3-5 files), or "large" (6+ files)',
        '- "value": "low", "medium", or "high"',
        "",
        "At least one idea should be for an existing project (spectre or conduit).",
        "One idea CAN be an entirely new standalone tool, script, or project if the user's",
        "interests or Reddit activity suggest something worth building from scratch.",
        "",
